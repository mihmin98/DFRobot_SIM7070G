/*!
 * @file DFRobot_SIM7070G.h
 * @brief Define the basic structure of DFRobot_SIM7070G class
 ...
 */
#ifndef __DFROBOT_SIM7070G_H__
#define __DFROBOT_SIM7070G_H__
...
class DFRobot_SIM7070G : public DFRobot_SIMcore {
public:
  /**
   * @enum eProtocol
